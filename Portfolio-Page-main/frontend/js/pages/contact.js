      ...
      <div class="contact-info-card fade-in">
        ...
        <div style="margin-top:24px;">
          ...
          <div style="display:flex;gap:10px;flex-wrap:wrap;">
            <a href="${escHtml(about?.github_url || 'https://github.com/')}" target="_blank" class="btn btn-ghost btn-sm">
              <i class="fab fa-github"></i> GitHub
            </a>
            <a href="${escHtml(about?.linkedin_url || 'https://linkedin.com/')}" target="_blank" class="btn btn-ghost btn-sm">
